...
public final class ARetDataTypeRetType extends PRetType
{
    private PDataType _dataType_;

    public ARetDataTypeRetType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARetDataTypeRetType(
            cloneNode(this._dataType_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseARetDataTypeRetType(this);
    }
